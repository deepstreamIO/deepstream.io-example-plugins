...
import { TOPIC, STATE_REGISTRY_TOPIC, JSONObject } from '@deepstream/protobuf/dist/types/all'
 ...
 * socketUserData passes the available info from socketWrapper { userId, serverData, clientData }
 */
